  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = "SELECT wo_form.id_wo, wo_form.id_login, wo_form.tanggal_penugasan, wo_form.target_selesai, wo_form.tanggal_selesai, wo_form.status, login.id_login, login.nama FROM wo_form INNER JOIN login ON wo_form.id_login = login.id_login WHERE wo_form.id_wo like '%".$cari."%'";				
            }else{
                $sql = "SELECT wo_form.id_wo, wo_form.id_login, wo_form.tanggal_penugasan, wo_form.target_selesai, wo_form.tanggal_selesai, wo_form.status,login.id_login, login.nama FROM wo_form INNER JOIN login ON wo_form.id_login = login.id_login";		
            }
            ...
            <tbody>
                ...
                <td><?php echo $row['id_wo']; ?></td>
                <td><?php echo $row['nama']; ?></td>
                <td><?php echo $row['tanggal_penugasan']; ?></td>
                <td><?php echo $row['target_selesai']; ?></td>
                <td><?php echo $row['tanggal_selesai']; ?></td>
                <td><?php echo $row['status']; ?></td>
                <td><a href="detail_wo.php?id_wo=<?php echo $row['id_wo'];?>" class="btn btn-success">Detail</a></td>
                </tr>
