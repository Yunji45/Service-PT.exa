  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = "SELECT dwr_form.id_dwr, dwr_form.nama, dwr_form.tanggal, dwr_form.status FROM dwr_form where dwr_form.nama like '%".$cari."%'";				
            }else{
                $sql = "SELECT dwr_form.id_dwr, dwr_form.nama, dwr_form.tanggal, dwr_form.status FROM dwr_form limit $halaman_awal, $batas";		
            }
