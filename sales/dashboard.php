        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <div class="kotak-info">
                ...
                <div class="card-body">
                    ...
                    <a href="wo.php" class="btn btn-primary" style="margin-top : 10px; "><p class="card-text" style="font-weight : bold; color: white;">Lihat Detail</p></a>
                </div>
                </div>
                <!-- akhir card 3 -->

                <!-- awal card 4 -->
                <div class="card bg-danger" style="width: 18rem; margin-left : 40px; position : absolute; margin-top : 230px;">
                <div class="card-body">
                    <div class="card-body-icon">
                    ...
                    <?php
                    $status = 'SETUJU';
                    $sql = "SELECT COUNT(*) id_kendala FROM kendala_form WHERE cek_kendala = '$status' ";
                    $result = $conn-> query($sql);
                        if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                    ?>
                    <div class ="display-4 text-white" style="font-weight : bold;"><?php echo $row['id_kendala'];}};?></div>
                    <a href="kendala.php" class="btn btn-dark" style="margin-top : 10px;"><p class="card-text" style="font-weight : bold; color: white;">Lihat Detail</p></a>
                </div>
                </div>
                <!-- akhir card 4 -->
