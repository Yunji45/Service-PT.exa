  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <a href="sales_form.php" class="btn btn-success">Tambah Laporan</a>
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = "SELECT * FROM sales_form INNER JOIN login ON sales_form.id_login = login.id_login WHERE login.id_login = '".$_SESSION['id_login']."' AND  sales_form.id_customer like '%".$cari."%'";
                
            }else{ 
               $sql = "SELECT * FROM sales_form INNER JOIN login ON sales_form.id_login = login.id_login WHERE login.id_login = '".$_SESSION['id_login']."' limit $halaman_awal, $batas";
            }
            ...
            <tbody>
                ...
                <td><a href="edit_sales.php?id_customer=<?php echo $row['id_customer'];?>" class="btn btn-warning">Edit</a></td>
                </tr>
            </tbody>
