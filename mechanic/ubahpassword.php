...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form action="../function/ubah_password.php" method="POST" enctype='multipart/form-data' class="bg-light" style="box-shadow: rgb(38, 57, 77) 0px 20px 30px -10px;">
            ...
            <div class="ml-4 pb-2">
                ...
                <button class="btn btn-primary mt-2" type="submit" onclick="return confirm('Yakin ingin diganti?')">Submit</button>
