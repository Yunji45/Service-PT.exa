  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = "SELECT dwr_form.id_dwr, dwr_form.nama, dwr_form.tanggal, dwr_form.status,dwr_form.serial_number FROM dwr_form where dwr_form.serial_number like '%".$cari."%' ORDER BY id_dwr DESC";				
            }else{
                $sql = "SELECT dwr_form.id_dwr, dwr_form.nama, dwr_form.tanggal, dwr_form.status, dwr_form.serial_number FROM dwr_form ORDER BY id_dwr DESC limit $halaman_awal, $batas";		
            }
            ...
            <tbody>
                ...
                <td><a href="detail_dwr.php?id_dwr=<?php echo $row['id_dwr'];?>" class="btn btn-success">Detail</a></td>
                </tr>
