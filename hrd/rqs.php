  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <form action="rqs.php" method="get">
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = "SELECT * from rqs_form where id_rqs like '%".$cari."%' ORDER BY id_rqs DESC";				
            }else{
                $sql = "SELECT * from rqs_form ORDER BY id_rqs DESC limit $halaman_awal, $batas";		
            }
            ...
            <tbody>
                ...
                <td><a href="detail_rqs.php?id_rqs=<?php echo $row['id_rqs'];?>" class="btn btn-success">Detail</a></td>
                </tr>
