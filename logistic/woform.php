...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <div class="form-group row">
              <label for="" class="col-sm-2 col-form-label">Jam Penugasan :</label>
              <div class="col-sm-2">
        ...
        <button class="btn btn-primary mt-2" type="submit" onclick="return confirm('Apakah anda yakin ingin menambahkan?')">Submit</button>
