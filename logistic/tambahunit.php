...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form action="../function/tambah_unit.php" method="POST" enctype='multipart/form-data' class="bg-light">
        <br>
        <div class="form-group row">
                <?php
                    $sql = "SELECT max(id_unit) as kodeTerbesar FROM unit_hmap";
                ...
                <div class="col-sm-3">
                    <input type="text" readonly class="form-control" value="<?php $huruf = "HMAP";
                    $kodeBarang = $huruf . sprintf("%05s", $urutan);
                    echo $kodeBarang;}};?>" name="id_unit">
                </div>
        </div>
