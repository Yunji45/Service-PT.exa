<?php
    ...
    $sql = "SELECT login.password, login.nama, login.id_login FROM login WHERE password='$password_lama'";
            ...
            if($password_baru == $konf_password){
                ...
                <body>
                    <div class="kotaknotif">
                        ...
                        <a href="../admin/admin.php"><button class="btn btn-warning tblback" >Back</button></a>
                    </div>
                ...
                <body>
                    <div class="kotaknotif">
                        ...
                        <a href="../admin/edituser.php?id_login=<?php echo $id_login;?>"><button class="btn btn-warning tblback" >Back</button></a>
                    </div>
                     <!-- Optional JavaScript; choose one of the two! -->
