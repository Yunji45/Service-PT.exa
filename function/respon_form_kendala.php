<?php
    ...
    $sql = "UPDATE kendala_form SET status_kendala = 'DIRESPON', jam_kendala_respon = '$jam_respon', tanggal_respon = '$tanggal_respon', respon_kendala = '$respon' WHERE id_kendala = '$id_kendala'";
    
   
    mysqli_query($conn, $sql);
    mysqli_close($conn);

    header('Location: ../sales/kendala.php');
    }
} else{
?>
