            ...
            if($password_baru == $konf_password){
                ...
                <body>
                    <div class="kotaknotif">
                        ...
                        <a href="../mechanic/admin.php"><button class="btn btn-warning tblback" >Back</button></a>
                    </div>
                ...
                <body>
                    <div class="kotaknotif">
                        ...
                        <a href="../mechanic/ubahpassword.php"><button class="btn btn-warning tblback" >Back</button></a>
                    </div>
                     <!-- Optional JavaScript; choose one of the two! -->
